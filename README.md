...
| **Latency** | UserPromptSubmit hook fast path: **3–4 ms** cold (median of 5 runs, Windows 11 / Node 22, v2.4.0). Reproduce: `echo '{"hook_event_name":"UserPromptSubmit","prompt":"hello"}' \| node plugins/godspeed/hooks/brain_hook_fast.js` and time it. Re-measure on your system — hook timing is environment-sensitive. |
